...
var TemplatePaths = []string{
	...
	"Backend/Core/Plugins/FFI",
	"Backend/Core/Plugins/FFI/IMPL-HPP",
	"Backend/Core/Plugins/FFI/IMPL-CPP",
	"Backend/Core/Plugins/FFI/IMPL-GoModulesForPlugin",
}
...
var FileMap = map[string]string{
	...
	"core:FFI_IMPL_CPP":    "Backend/Core/Plugins/FFI/IMPL-CPP/CPPImplementation.cpp", // CPP Wrapper interfaces and files
	"core:FFI_IMPL_HPP":    "Backend/Core/Plugins/FFI/IMPL-HPP/CPPImplementation.hpp", // CPP Wrapper interfaces and files
