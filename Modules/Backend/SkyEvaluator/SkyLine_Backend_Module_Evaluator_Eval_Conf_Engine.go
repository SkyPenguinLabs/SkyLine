...
import (
	SLC "SkyLine/Modules/Backend/SkyConfEngine/EngineCore"
	SLE "SkyLine/Modules/Backend/SkyEnvironment"
)
...
func EvalEngineCall(val SLE.SL_Object) SLE.SL_Object {
	...
	case *SLE.SL_String:
		SLC.StartEngine_RenderFile(Value.SkyLine_ObjectFunction_GetTrueValue())
