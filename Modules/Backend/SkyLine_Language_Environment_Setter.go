...
//
//
// Defines       | Defines a function to set a variable and register the variable into the local environment
//
//
package SkyLine_Backend
...
func (e *Environment_of_environment) Set(name string, val SLC_Object) SLC_Object {
