...
//															━━━━┛
//
// Filename          | SkyLine_Backend_Module_Environment_Object_BuiltinType
// Extension         | .go ( golang source code file )
// Purpose           | Defines required states for the Builtin data type
...
func (SL_ObjectBuiltin *SL_Builtin) SkyLine_ObjectFunction_GetDataType() ObjectDataType {
	return SKYLINE_DATATYPE_BUILTIN_OBJECT
}
...
func (SL_ObjectBuiltin *SL_Builtin) SkyLine_ObjectFunction_GetTrueValue() string {
	return "SkyLine Builtin function :: Standard library function / Invoke?"
}
