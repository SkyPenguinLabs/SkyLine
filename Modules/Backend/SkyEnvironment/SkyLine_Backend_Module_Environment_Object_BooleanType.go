...
//															━━━━┛
//
// Filename          | SkyLine_Backend_Module_Environment_Object_BooleanType
// Extension         | .go ( golang source code file )
// Purpose           | Defines required states for the Boolean data type
...
func (SL_ObjectBoolean *SL_Boolean) SkyLine_ObjectFunction_GetTrueValue() string {
	return fmt.Sprintf("%t", SL_ObjectBoolean.Value)
}
