...
//															━━━━┛
//
// Filename          | SkyLine_Backend_Module_Environment_Object_ErrorType
// Extension         | .go ( golang source code file )
// Purpose           | Defines required states for the Error data type
...
func (SL_ObjectError *SL_Error) SkyLine_ObjectFunction_GetDataType() ObjectDataType {
	return SKYLINE_DATATYPE_ERROR_OBJECT
}
