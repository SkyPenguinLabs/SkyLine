...
// Purpose           | Defines required states for the return data type
...
func (SL_ObjectReturn *SL_Return) SkyLine_ObjectFunction_GetTrueValue() string {
	return SL_ObjectReturn.Value.SkyLine_ObjectFunction_GetTrueValue()
}
