...
//															━━━━┛
//
// Filename          | SkyLine_Backend_Module_Environment_Object_ModuleType
// Extension         | .go ( golang source code file )
// Purpose           | Defines required states for the Module data type
...
func (SL_RegValue *SL_RegisterType) SkyLine_ObjectFunction_GetDataType() ObjectDataType {
	return SKYLINE_DATATYPE_REGISTER_OBJECT
}
...
func (SL_RegValue *SL_RegisterType) SkyLine_ObjectFunction_GetTrueValue() string {
	return SL_RegValue.Value.SkyLine_ObjectFunction_GetTrueValue()
}
