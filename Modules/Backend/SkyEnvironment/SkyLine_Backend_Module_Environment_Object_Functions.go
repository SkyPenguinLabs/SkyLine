...
func (SL_ObjectFunction *SL_Functions) SkyLine_ObjectFunction_GetTrueValue() string {
	...
	for _, param := range SL_ObjectFunction.Sky_Function_Arguments {
	...
	Out.WriteString(")")
	Out.WriteString("{\n")
	Out.WriteString(SL_ObjectFunction.Unit.SkyLine_NodeInterface_Get_Node_Value())
	Out.WriteString("\n};")
	return Out.String()
}
...
func (SL_ObjectFunction *SL_Functions) SkyLine_ObjectFunction_GetDataType() ObjectDataType {
	return SKYLINE_DATATYPE_FUNCTION_OBJECT
}
