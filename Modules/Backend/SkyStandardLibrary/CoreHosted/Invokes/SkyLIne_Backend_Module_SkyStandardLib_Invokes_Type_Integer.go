...
// :::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
//
// Defines       | This file defines all invoke and object call functions for the Integer data type within the SkyLine programming language
//
//
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
...
func Integer_Outln(Value int, Env SkyEnv.SkyLineEnvironment, args ...SkyEnv.SL_Object) SkyEnv.SL_Object {
	fmt.Println(Value)
	return &SkyEnv.SL_NULL{}
}

func Integer_Out(Value int, Env SkyEnv.SkyLineEnvironment, args ...SkyEnv.SL_Object) SkyEnv.SL_Object {
	fmt.Print(Value)
	return &SkyEnv.SL_NULL{}
}

func Integer_Str(Value int, Env SkyEnv.SkyLineEnvironment, args ...SkyEnv.SL_Object) SkyEnv.SL_Object {
	return &SkyEnv.SL_String{Value: fmt.Sprint(Value)}
}

func Integer_Bool(Value int, Env SkyEnv.SkyLineEnvironment, args ...SkyEnv.SL_Object) SkyEnv.SL_Object {
	numStr := strconv.Itoa(Value)
	length := len(numStr)
	if length > 1 {
		first := strings.Split(numStr, "")
		switch first[0] {
		case "1":
	...
	return &SkyEnv.SL_Error{Message: "Sorry, but in order for an integer to be converted to the boolean, integers must start with a 0 or 1, or be a 0 or a 1.\n"}
}
