...
func InitateCallRegisterStandardCall() {
	...
	SkyEval.SkyLine_Register_Builtin("quit", func(Environ *SkyEnv.SkyLineEnvironment, InvokeArgs ...SkyEnv.SL_Object) SkyEnv.SL_Object {
		return (Quit(InvokeArgs...))
	})
	SkyEval.SkyLine_Register_Builtin("halt", func(Environ *SkyEnv.SkyLineEnvironment, InvokeArgs ...SkyEnv.SL_Object) SkyEnv.SL_Object {
		return (Halt(InvokeArgs...))
	})
	SkyEval.SkyLine_Register_Builtin("isroot", func(Environ *SkyEnv.SkyLineEnvironment, InvokeArgs ...SkyEnv.SL_Object) SkyEnv.SL_Object {
		return (UserRoot(InvokeArgs...))
	})
	SkyEval.SkyLine_Register_Builtin("InitiatePlugin", func(Environ *SkyEnv.SkyLineEnvironment, InvokeArgs ...SkyEnv.SL_Object) SkyEnv.SL_Object {
		return (SkyPlugin.InitatePlugin(Environ, InvokeArgs...))
	})
	SkyEval.SkyLine_Register_Builtin("ExecuteFF", func(Environ *SkyEnv.SkyLineEnvironment, InvokeArgs ...SkyEnv.SL_Object) SkyEnv.SL_Object {
		return (SkyPlugin.ExecutePluginFunction(Environ, InvokeArgs...))
	})
	SkyEval.SkyLine_Register_Builtin("PluginPopLoadBuff", func(Environ *SkyEnv.SkyLineEnvironment, InvokeArgs ...SkyEnv.SL_Object) SkyEnv.SL_Object {
		return (SkyPlugin.ExecutePluginLoadBuffer(Environ, InvokeArgs...))
	})
	SkyEval.SkyLine_Register_Builtin("PluginDumpEnvBuffer", func(Environ *SkyEnv.SkyLineEnvironment, InvokeArgs ...SkyEnv.SL_Object) SkyEnv.SL_Object {
		return (SkyPlugin.ExecutePluginEnvironmentBufferView(Environ, InvokeArgs...))
	})
	SkyEval.SkyLine_Register_Builtin("PluginExtractVarList", func(Environ *SkyEnv.SkyLineEnvironment, InvokeArgs ...SkyEnv.SL_Object) SkyEnv.SL_Object {
		return (SkyPlugin.ExecutePluginExtractAllVarList(Environ, InvokeArgs...))
	})
