...
var (
	InputMapType = map[SkyEnv.ObjectDataType]InputFunction{
		SkyEnv.SKYLINE_DATATYPE_STRING_OBJECT: func(value string) SkyEnv.SL_Object {
			return &SkyEnv.SL_String{Value: value}
		},
		SkyEnv.SKYLINE_DATATYPE_INTEGER64_OBJECT: func(value string) SkyEnv.SL_Object {
		...
		SkyEnv.SKYLINE_DATATYPE_BOOLEAN_OBJECT: func(value string) SkyEnv.SL_Object {
		...
		SkyEnv.SKYLINE_DATATYPE_FLOAT_OBJECT: func(value string) SkyEnv.SL_Object {
